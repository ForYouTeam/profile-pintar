...
<div class="float-left">
    <div class="page-header-title">
        <h5 class="m-b-10">SEKTOR TABEL</h5>
    </div>
    <ul class="breadcrumb">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body mx-3">
          <div class="form-group mb-3">
            ...
            <label for="_sektor">Nama Sektor</label>
            <input id="_sektor" type="text" class="form-control" placeholder="--input disini--" autocomplete="off">
            <p id="alert_sektor" class="text-danger mt-2"></p>
          </div>
          <div class="form-group mb-3">
            <input type="hidden" id="id">
            <label for="kontak">Kontak</label>
            <input id="kontak" type="text" class="form-control" placeholder="--input disini--" autocomplete="off">
            <p id="alertkontak" class="text-danger mt-2"></p>
          </div>
          <div class="form-group mb-3">
            <input type="hidden" id="id">
          ...
          <div class="form-group mb-3">
            ...
            <textarea id="alamat" cols="30" rows="10" class="form-control" placeholder="--input disini--" autocomplete="off"></textarea>
            <p id="alertalamat" class="text-danger mt-2"></p>
          </div>
        </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#btn-del', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url    : `${baseUrl}/api/v2/sektor/${dataId}`,
                        type   : 'delete',
        ...
        $(document).on('click', '#btn-edit', function() {
            clearInput()
            let dataId = $(this).data('id')
            $.get(`${baseUrl}/api/v2/sektor/${dataId}`, (res) => {
                let data = res.data
                $.each(data, (i,d) => {
            ...
            $.get(`${baseUrl}/api/v2/sektor`, (res) => {
                ...
                $.each(data, (i,d) => {
                    $('#tbody').append(`
                        <tr>
                            <td>${i + 1}</td>
                            <td class="text-capitalize">${d._sektor}</td>
