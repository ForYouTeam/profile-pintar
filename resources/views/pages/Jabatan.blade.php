...
<div class="float-left">
    <div class="page-header-title">
        <h5 class="m-b-10">JABATAN TABEL</h5>
    </div>
    <ul class="breadcrumb">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body mx-3">
          <div class="form-group mb-5">
            ...
            <label for="_jabatan">Nama Jabatan</label>
            <input id="_jabatan" type="text" class="form-control" placeholder="--input disini--" autocomplete="off">
            <p id="alert_jabatan" class="text-danger mt-2"></p>
          </div>
          <div class="form-group mb-3">
            <label for="deskripsi">Deskripsi</label>
            <textarea id="deskripsi" cols="30" rows="10" class="form-control" placeholder="--input disini--" autocomplete="off"></textarea>
            <p id="alertdeskripsi" class="text-danger mt-2"></p>
          </div>
        </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#btn-del', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: `${baseUrl}/api/v2/jabatan/${dataId}`,
                        type: 'delete',
        ...
        $(document).on('click', '#btn-edit', function() {
            clearInput()
            let dataId = $(this).data('id')
            $.get(`${baseUrl}/api/v2/jabatan/${dataId}`, (res) => {
                let data = res.data
                $.each(data, (i,d) => {
        ...
        function getAllData() {
            ...
            $.get(`${baseUrl}/api/v2/jabatan`, (res) => {
                let data = res.data
                ...
                $.each(data, (i,d) => {
                    $('#tbody').append(`
                        <tr>
                            <td>${i + 1}</td>
                            <td class="text-capitalize">${d._jabatan}</td>
